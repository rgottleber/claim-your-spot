...
contract ClaimYourSpot is VRFConsumerBaseV2 {
  ...
  function fulfillRandomWords(
    ...
    address _addr = requestIdToAddress[requestId];
    addressToRandomNumber[_addr] = randomWords[0];
    spots.push(randomWords[0]);
    emit SpotClaimed("New Spot Claimed");
  }

  function getAllSpots() public view returns(uint256[] memory){
    return spots;
  }
